...
def unet(input_size=(None, None, 3), num_classes=1, activation='sigmoid'):
    ...
    merge6 = tf.keras.backend.concatenate([drop4, up6], axis=3)
    ...
    merge7 = tf.keras.backend.concatenate([conv3, up7], axis=3)
    ...
    merge8 = tf.keras.backend.concatenate([conv2, up8], axis=3)
    ...
    merge9 = tf.keras.backend.concatenate([conv1, up9], axis=3)
    conv9 = tf.keras.layers.Conv2D(64, 3, activation='relu', padding='same', kernel_initializer='he_normal')(merge9)
    conv9 = tf.keras.layers.Conv2D(64, 3, activation='relu', padding='same', kernel_initializer='he_normal')(conv9)
    # conv9 = tf.keras.layers.Conv2D(2, 3, activation='relu', padding='same', kernel_initializer='he_normal')(conv9)
    conv10 = tf.keras.layers.Conv2D(num_classes, 1, activation=activation)(conv9)
