...
# model = tf.keras.models.load_model('CI/InceptionResNetV2_3_real.tf')
# model = tf.keras.models.load_model('CI/InceptionResNetV2_3_fake.tf')
model = tf.keras.models.load_model('CI/InceptionResNetV2_3_fine.tf')
